...
public class graficador extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        int b = 50;
        int c = 50;
        if (programa.text_a.getText().length() == 0 || programa.text_b.getText().length() == 0 || programa.text_c.getText().length() == 0) {

            //Vacio
        } else {
            try{
            a = Integer.parseInt(programa.text_a.getText());
            b = Integer.parseInt(programa.text_b.getText());
            c = Integer.parseInt(programa.text_c.getText());
            }catch(Exception e){
                programa.MensajeError();
            }
